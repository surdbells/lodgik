...
class AssetIncident implements TenantAware
{
    ...
    #[ORM\Column(name: 'description', type: Types::TEXT)] private string $description;
    ...
    #[ORM\Column(name: 'status', type: Types::STRING, length: 15, options: ['default' => 'new'])] private string $status = 'new';
