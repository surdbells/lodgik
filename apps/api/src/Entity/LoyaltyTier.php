...
class LoyaltyTier implements TenantAware
{
    ...
    #[ORM\Column(name: 'name', type: Types::STRING, length: 50)] private string $name;
    ...
    #[ORM\Column(name: 'color', type: Types::STRING, length: 20, nullable: true)] private ?string $color = null;
