...
class ServiceEngineer implements TenantAware
{
    ...
    #[ORM\Column(name: 'phone', type: Types::STRING, length: 20)] private string $phone;
    ...
    #[ORM\Column(name: 'whatsapp', type: Types::STRING, length: 20, nullable: true)] private ?string $whatsapp = null;
    ...
    #[ORM\Column(name: 'availability', type: Types::STRING, length: 15, options: ['default' => 'business_hours'])] private string $availability = 'business_hours';
