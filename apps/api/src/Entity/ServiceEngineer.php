...
class ServiceEngineer implements TenantAware
{
    ...
    #[ORM\Column(name: 'emergency_phone', type: Types::STRING, length: 20)] private string $phone;
    ...
    #[ORM\Column(name: 'sla_response_minutes', type: Types::STRING, length: 20, nullable: true)] private ?string $whatsapp = null;
    ...
    #[ORM\Column(name: 'is_active', type: Types::STRING, length: 15, options: ['default' => 'business_hours'])] private string $availability = 'business_hours';
