...
@Component({
  ...
  template: `
    <ui-page-header title="Leads" subtitle="Manage your lead pipeline">
    ...
    @if (showForm()) {
      <div class="bg-white rounded-lg border border-gray-200 p-5 mb-6">
        ...
        <div class="flex gap-2 mt-4">
          <button (click)="create()" class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700">Create Lead</button>
