...
@Component({ selector:'app-platform', standalone:true, imports:[CommonModule], templateUrl:'./platform.component.html', styleUrl:'./platform.component.scss' })
export class PlatformComponent {
  apps=[
    {icon:'💼',title:'Hotel Web PMS',desc:'Full management app for all staff roles',badge:'Web',cls:'web'},
    {icon:'🛎️',title:'Reception App',desc:'Quick check-in/out, walk-ins, NFC cards',badge:'Android',cls:'android'},
    ...
    {icon:'📟',title:'Concierge Tablet',desc:'In-room guest self-service kiosk',badge:'Android',cls:'android'},
